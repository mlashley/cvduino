...
void setup() {
  ...
  // Timer1 WGM[13:10] = 0011 PWM, phase correct, 10-bit.
  ...
  TCCR1B = TCCR1B & B11111000 | B00000001; // set timer 1 divisor (CS12:10) to 001 for PWM frequency of 7820.13 Hz (16MHz / 2046 with 10 bit mode phase-correct PWM)
